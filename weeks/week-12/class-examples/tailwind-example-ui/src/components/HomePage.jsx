          ...
          <div className="w-full lg:w-1/2 px-4 mb-12 lg:mb-0">
            <div className="max-w-lg">
              ...
              <p className="leading-relaxed lg:text-xl lg:leading-relaxed text-indigo-50 font-nella">
                Technigo is a new form of education, a fast paced tech education
                formed to teach the latest technologies. For us, technology is
                creative. It’s a tool that enables you to reach and affect many
                people globally. Together with successful tech companies we
                educate people to build future digital experiences.
              </p>
            </div>
          </div>
